...
# seq 1 10 | parallel -j10 -k "cd ./http-parser-{} && ./$2 large.log >> /home/zhongfa/benchmarks/run/results/results-http.log"
seq 1 10 | parallel -j10 -k "cd ./http-parser-{} && (time ./$2 large.log) 2>> /home/zhongfa/benchmarks/run/results/results-http.log"
