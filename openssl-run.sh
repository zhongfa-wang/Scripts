...
# seq 1 10 |sudo parallel -j10 -k "cd ./openssl-benchmark-{} && ./$2 speed rsa dsa ecdsa >&1 | grep -o "real.*" >> /home/zhongfa/benchmarks/run/results/results-openssl.log"
...
seq 1 10 |sudo parallel -j10 -k "cd ./openssl-benchmark-{} && ./$2 speed rsa > /home/zhongfa/benchmarks/run/results/results-openssl-rsa-{}.log"
seq 1 10 |sudo parallel -j10 -k "cd ./openssl-benchmark-{} && ./$2 speed dsa > /home/zhongfa/benchmarks/run/results/results-openssl-dsa-{}.log"
seq 1 10 |sudo parallel -j10 -k "cd ./openssl-benchmark-{} && ./$2 speed ecdsa > /home/zhongfa/benchmarks/run/results/results-openssl-ecdsa-{}.log"
